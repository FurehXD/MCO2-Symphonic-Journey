...
LevelTwo::LevelTwo()
{
    ...
    leftBorder->getShape().setFillColor(sf::Color::Red);
    ...
    bottomBorder->getShape().setFillColor(sf::Color::Red);
...
void LevelTwo::playMusicLevel() {
    PlaySound(TEXT("Assets/bgmoonlightSonata.wav"), NULL, SND_ASYNC);
}